...
function About() {
  return (
    <div>
      ...
      <span><h1 className='text-center text-6xl font-bold shadow-lg'>ABOUT</h1></span>
      <div className='flex justify-center'>
        <div className='w-4/5 flex'>
            <img className='w-40 h-40 mt-10 mr-10 rounded-xl shadow-xl' src="https://prasadyash2411.github.io/ecom-website/img/Band%20Members.png" alt="band" />
            <p className='mt-10 border-2 rounded-xl p-8 bg-slate-300  text-justify'>
